...
DL="$HOME/Downloads"
ARCHIVE="$DL/OpenDeck-v2.0.1-CUSTOMIZATION-SOURCE.tar.xz"
EXPECTED_ARCHIVE_SHA="f098e491b977ab83419403416645203e0e3f4cbc8ef7f4be1822e3523c86b1ce"
EXPECTED_SOURCE_COMMIT="3c1c739006ebc5b4cd0eb0da6420c5f2f81cc1eb"
SRC="$DL/OpenDeck-v2.0.1-CUSTOMIZATION-SOURCE"
STUDIO="$SRC/apps/opendeck-studio"
INSTALL_ROOT="$HOME/.local/lib/opendeck-v2.0.1"
USER_BIN="$HOME/.local/bin"
VERIFY="$DL/OpenDeck-v2.0.1-CUSTOMIZATION-VERIFY.txt"
ROLLBACK="$DL/OpenDeck-v2.0.1-CUSTOMIZATION-ROLLBACK.txt"
LOGDIR="$DL/OpenDeck-v2.0.1-CUSTOMIZATION-logs"
...
fail() {
  local stage="$1"
  local rc="${2:-1}"
  say "OPENDECK_V2_0_1_CUSTOMIZATION=FAIL:$rc"
...
say "OPENDECK_V2_0_1_CUSTOMIZATION=START"
...
# Canonical source checks happen before npm/cargo generate build artifacts.
...
# Native gate. Generate/fetch one lockfile for this exact qualified tree, then keep it locked.

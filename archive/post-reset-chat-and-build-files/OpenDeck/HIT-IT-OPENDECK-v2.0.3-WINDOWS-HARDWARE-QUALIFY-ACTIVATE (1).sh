...
DL="$HOME/Downloads"
ARCHIVE="$DL/OpenDeck-v2.0.3-WINDOWS-HARDWARE-SOURCE.tar.xz"
EXPECTED_ARCHIVE_SHA="cc9b1ac934923ad8301d3356a8b3a82920ac1c0dba3d19a11fb40b7acac71eb3"
EXPECTED_SOURCE_COMMIT="d6d19b9d308086f9b0164eacc49ea2504764818c"
EXPECTED_PREVIOUS_SHA="ec7594e2d6bde90b9cc2ee0c43c7e03ed263346b23bbec681e385c43c8089037"
...
VERIFY="$DL/OpenDeck-v2.0.3-WINDOWS-HARDWARE-VERIFY.txt"
ROLLBACK="$DL/OpenDeck-v2.0.3-WINDOWS-HARDWARE-ROLLBACK.txt"
LOGDIR="$DL/OpenDeck-v2.0.3-WINDOWS-HARDWARE-logs"
...
say "OPENDECK_STABLE_V2_0_2_PRESERVE_UNTIL_GREEN=YES"
...
# v2.0.2 remains the authoritative rollback until every v2.0.3 software gate is green.
[[ -x "$USER_BIN/opendeck-studio" ]] || fail "ACTIVE_V202_BINARY_MISSING:$USER_BIN/opendeck-studio" 2
...
say "OPENDECK_V202_ACTIVE_TARGET=$BASELINE_TARGET"
say "OPENDECK_V202_ACTIVE_BINARY_SHA256=$BASELINE_SHA"
[[ "$BASELINE_SHA" == "$EXPECTED_PREVIOUS_SHA" ]] || fail "ACTIVE_V202_BASELINE_SHA_MISMATCH" 2
...
# New frontend and hardware paths require a complete clean frontend qualification.

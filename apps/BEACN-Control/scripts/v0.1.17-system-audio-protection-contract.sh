...
fail() { echo "AETHERFORGE_BEACN_V0_1_17_SYSTEM_AUDIO_PROTECTION=FAIL:$1"; exit 1; }

grep -q '^version = "0.1.17"$' "$ROOT/Cargo.toml" || fail version
...
echo 'AETHERFORGE_BEACN_V0_1_17_SYSTEM_AUDIO_PROTECTION=PASS'

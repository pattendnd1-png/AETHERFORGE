...
fail(){ echo "AETHERFORGE_BEACN_V0_1_21_CLIPPY_TEST_STYLE=FAIL:$1"; exit 1; }
...
echo 'AETHERFORGE_BEACN_V0_1_21_CLIPPY_TEST_STYLE=PASS'
...
echo 'AETHERFORGE_BEACN_V0_1_21_HOST_CLIPPY_FIXES=PASS'

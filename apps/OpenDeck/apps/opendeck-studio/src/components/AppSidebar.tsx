...
export const AppSidebar = memo(function AppSidebar({ section, onSectionChange }: AppSidebarProps) {
  return <aside className="app-sidebar" data-layout-region="sidebar">
    ...
    <footer className="sidebar-footer"><span className="sidebar-heart">♥</span><div><strong>OpenDeck+ 2.0.53</strong><small>Open Source. More possibilities.</small></div></footer>
  </aside>;
});

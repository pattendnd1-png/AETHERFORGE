...
const QUALIFICATION_MODE = QUALIFICATION_PARAMS.get('qualification') === 'v212';
...
export default function EditorApp() {
  ...
  const [hardwareStatus, setHardwareStatus] = useState<StreamDeckStatus>(QUALIFICATION_MODE
    ? { state: 'connected', model: 'Stream Deck +', serial: 'QUALIFY-V212', message: 'Connected' }
  ...
  return <div className="app-shell v212-shell">
    <TopBar

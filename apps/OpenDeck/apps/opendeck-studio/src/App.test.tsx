...
beforeEach(() => {
  ...
  vi.mocked(bridge.qualificationFocusWindow).mockResolvedValue({ release: '2.0.22', pid: 1234, title: 'OpenDeck+ 2.0.22 Qualification [1234]' });
...
describe('OpenDeck 2.0.22 editor', () => {

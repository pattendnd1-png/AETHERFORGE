...
beforeEach(() => {
  ...
  vi.mocked(bridge.qualificationFocusWindow).mockResolvedValue({ release: '2.0.35', pid: 1234, title: 'OpenDeck+ 2.0.35 Qualification [1234]' });
...
describe('OpenDeck 2.0.35 editor', () => {

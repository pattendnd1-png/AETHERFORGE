...
beforeEach(() => {
  ...
  vi.mocked(bridge.pluginHostStatus).mockResolvedValue({ protocolVersion: '2.0.44', streamDeckCompatibilityTarget: '7.6', websocketHost: '127.0.0.1', installed: 0, active: 0, enabled: 0 });
  ...
  vi.mocked(bridge.qualificationFocusWindow).mockResolvedValue({ release: '2.0.44', pid: 1234, title: 'OpenDeck+ 2.0.44 Qualification [1234]' });
...
describe('OpenDeck 2.0.44 editor', () => {

    ...
    tauri::Builder::default()
        ...
        .on_window_event(|window, event| {
            if matches!(event, tauri::WindowEvent::CloseRequested { .. }) {
                ...
                window.app_handle().state::<plugin_host::Service>().stop_all();
            }
        })
        .invoke_handler(tauri::generate_handler![
            ...
            pack_manager::icon_pack_list,
            pack_manager::icon_pack_install,
            pack_manager::icon_pack_set_active,
            pack_manager::icon_pack_remove,

...
OpenDeck is a clean-room Linux Stream Deck controller/editor. v2.0.5 builds on the qualified v2.0.4 Windows-style editor and Stream Deck + HID runtime, completing the Twitch device sign-in polling flow while interface-parity work is being audited against the Windows Stream Deck editor.

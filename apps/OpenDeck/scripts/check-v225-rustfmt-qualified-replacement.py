...
activate = root / 'scripts/activate-v225-qualified.sh'
...
if activate.is_file():
    ...
    for name, needle in [
        ...
        ('INSTALL_V225', 'TARGET_VERSION="2.0.25"'),
...
if failed:
    print('OPENDECK_V225_RUSTFMT_QUALIFIED_REPLACEMENT=FAIL:' + ','.join(failed))
    raise SystemExit(1)
print('OPENDECK_V225_RUSTFMT_QUALIFIED_REPLACEMENT=PASS')

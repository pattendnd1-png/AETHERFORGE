...
activate = root / 'scripts/activate-v228-qualified.sh'
...
if activate.is_file():
    ...
    for name, needle in [
        ...
        ('INSTALL_V228', 'TARGET_VERSION="2.0.28"'),
...
if failed:
    print('OPENDECK_V228_RUSTFMT_QUALIFIED_REPLACEMENT=FAIL:' + ','.join(failed))
    raise SystemExit(1)
print('OPENDECK_V228_RUSTFMT_QUALIFIED_REPLACEMENT=PASS')

...
activate = root / 'scripts/activate-v226-qualified.sh'
...
if activate.is_file():
    ...
    for name, needle in [
        ...
        ('INSTALL_V226', 'TARGET_VERSION="2.0.26"'),
...
if failed:
    print('OPENDECK_V226_RUSTFMT_QUALIFIED_REPLACEMENT=FAIL:' + ','.join(failed))
    raise SystemExit(1)
print('OPENDECK_V226_RUSTFMT_QUALIFIED_REPLACEMENT=PASS')

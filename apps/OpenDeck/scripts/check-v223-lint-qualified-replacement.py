...
activate = root / 'scripts/activate-v223-qualified.sh'
...
if activate.is_file():
    ...
    for name, needle in [
        ...
        ('INSTALL_V223', 'TARGET_VERSION="2.0.23"'),
...
if failed:
    print('OPENDECK_V223_LINT_QUALIFIED_REPLACEMENT=FAIL:' + ','.join(failed))
    raise SystemExit(1)
print('OPENDECK_V223_LINT_QUALIFIED_REPLACEMENT=PASS')

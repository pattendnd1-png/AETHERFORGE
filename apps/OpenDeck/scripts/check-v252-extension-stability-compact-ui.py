...
for name, ok in checks.items():
    print(f'OPENDECK_V252_{name}={"PASS" if ok else "FAIL"}')
if failed:
    print('OPENDECK_V252_EXTENSION_STABILITY_COMPACT_UI=FAIL:' + ','.join(failed))
    sys.exit(1)
print('OPENDECK_V252_EXTENSION_STABILITY_COMPACT_UI=PASS')

...
if enabled and not feature:
    print('OPENDECK_V248_TAURI_ASSET_PROTOCOL_FEATURE_CLOSURE=FAIL:assetProtocol_enabled_but_protocol_asset_feature_missing')
    sys.exit(1)
print('OPENDECK_V248_TAURI_ASSET_PROTOCOL_FEATURE_CLOSURE=PASS')

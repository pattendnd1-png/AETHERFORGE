...
activate = root / 'scripts/activate-v229-qualified.sh'
...
if activate.is_file():
    ...
    for name, needle in [
        ...
        ('INSTALL_V229', 'TARGET_VERSION="2.0.29"'),
...
if failed:
    print('OPENDECK_V229_RUSTFMT_QUALIFIED_REPLACEMENT=FAIL:' + ','.join(failed))
    raise SystemExit(1)
print('OPENDECK_V229_RUSTFMT_QUALIFIED_REPLACEMENT=PASS')

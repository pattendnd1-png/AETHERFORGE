...
require('apps/opendeck-studio/src-tauri/src/lib.rs', [
    ...
    '.max_depth(3)',
    'spawn_blocking(scan_marketplace_downloads_blocking)'
...
for ok, msg in checks:
    print(f"OPENDECK_V254_CONTRACT_{msg}={'PASS' if ok else 'FAIL'}")
if failed:
    print('OPENDECK_V254_DEVICE_ICON_PLUGIN_INSTALL_OBS_TOGGLE=FAIL')
    sys.exit(1)
print('OPENDECK_V254_DEVICE_ICON_PLUGIN_INSTALL_OBS_TOGGLE=PASS')

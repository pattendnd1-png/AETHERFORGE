...
activate = root / 'scripts/activate-v224-qualified.sh'
...
if activate.is_file():
    ...
    for name, needle in [
        ...
        ('INSTALL_V224', 'TARGET_VERSION="2.0.24"'),
...
if failed:
    print('OPENDECK_V224_RUSTFMT_QUALIFIED_REPLACEMENT=FAIL:' + ','.join(failed))
    raise SystemExit(1)
print('OPENDECK_V224_RUSTFMT_QUALIFIED_REPLACEMENT=PASS')

...
for k,v in checks.items(): print(f"OPENDECK_V255_{k.upper()}={'PASS' if v else 'FAIL'}")
if failed:
  print('OPENDECK_V255_PLUGIN_PACK_SIDEBAR_TEST_CLOSURE=FAIL:'+','.join(failed))
  raise SystemExit(1)
print('OPENDECK_V255_PLUGIN_PACK_SIDEBAR_TEST_CLOSURE=PASS')

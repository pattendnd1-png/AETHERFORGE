...
qualifier_path = root / 'scripts/qualify-v237-host.sh'
...
menu_path = root / 'scripts/check-v237-menu-launch.sh'
...
checks = {
    ...
    'V237_ACTIVATOR_EXISTS': activator_path.exists(),
    'V237_QUALIFIER_EXISTS': qualifier_path.exists(),
    ...
    'MENU_LAUNCH_VISIBILITY_CHECK': 'OPENDECK_STARTUP_PROBE_FILE' in menu and 'nativeVisible' in menu and 'frontendVisible' in menu,
...
if not all(checks.values()):
    raise SystemExit(1)
print('OPENDECK_V237_VISIBLE_STARTUP_KDE_LAUNCHER_CONTRACT=PASS')

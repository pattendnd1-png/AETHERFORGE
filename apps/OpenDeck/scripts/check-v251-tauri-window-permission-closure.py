...
menu = (root/'scripts/check-v251-system-menu-launch.sh').read_text()
errors = []
...
if errors:
    print('OPENDECK_V251_TAURI_WINDOW_PERMISSION_CLOSURE=FAIL:' + ';'.join(errors))
    sys.exit(1)
print('OPENDECK_V251_TAURI_WINDOW_PERMISSION_CLOSURE=PASS')

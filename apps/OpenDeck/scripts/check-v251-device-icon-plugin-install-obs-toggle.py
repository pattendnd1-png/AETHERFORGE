...
for ok, msg in checks:
    print(f"OPENDECK_V251_CONTRACT_{msg}={'PASS' if ok else 'FAIL'}")
if failed:
    print('OPENDECK_V251_DEVICE_ICON_PLUGIN_INSTALL_OBS_TOGGLE=FAIL')
    sys.exit(1)
print('OPENDECK_V251_DEVICE_ICON_PLUGIN_INSTALL_OBS_TOGGLE=PASS')

...
checks = {
    ...
    'root_version': ('Cargo.toml', 'version = "2.0.46"'),
    'studio_version': ('apps/opendeck-studio/package.json', '"version": "2.0.46"'),
    'tauri_version': ('apps/opendeck-studio/src-tauri/Cargo.toml', 'version = "2.0.46"'),
    'tauri_conf_version': ('apps/opendeck-studio/src-tauri/tauri.conf.json', '"version": "2.0.46"'),
}
errors = []
...
if errors:
    print('OPENDECK_V2_0_46_ACTION_WHEEL_CONTRACT=FAIL')
    for error in errors:
        print('ACTION_WHEEL_CONTRACT_ERROR=' + error)
    sys.exit(1)
print('OPENDECK_V2_0_46_ACTION_WHEEL_CONTRACT=PASS')

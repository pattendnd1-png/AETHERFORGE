...
text=path.read_text()
checks={
    'NO_DEAD_CODE_PATH_MAC': 'code_path_mac:' not in text,
...
if failed:
    print('OPENDECK_V244_PLUGIN_HOST_STRICT_CLIPPY_CLOSURE=FAIL:'+','.join(failed))
    sys.exit(1)
print('OPENDECK_V244_PLUGIN_HOST_STRICT_CLIPPY_CLOSURE=PASS')

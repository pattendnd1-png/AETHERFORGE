...
for k,v in checks.items(): print(f'OPENDECK_V229_TEST_CONTRACT_{k}={"PASS" if v else "FAIL"}')
if not all(checks.values()):
 print('OPENDECK_V229_TEST_CONTRACT=FAIL'); sys.exit(1)
print('OPENDECK_V229_TEST_CONTRACT=PASS')

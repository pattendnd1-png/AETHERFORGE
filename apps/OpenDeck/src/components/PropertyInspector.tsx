...
export const PropertyInspector = memo(function PropertyInspector({ slot, pages, profiles, collapsed, onToggleCollapsed, onConfig, onClear, interaction, onInteraction, onTest, onAppearance, onState, onResetState, onCopyState, previewState, onPreviewState, onOpenAssets, onSelectPrevious, onSelectNext }: Props) {
  ...
  const selectionLabel=slot ? `${kindLabel(slot.kind)} ${slot.position+1}` : 'No Selection';

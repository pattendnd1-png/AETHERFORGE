...
beforeEach(() => {
  ...
  vi.mocked(bridge.qualificationFocusWindow).mockResolvedValue({ release: '2.0.30', pid: 1234, title: 'OpenDeck+ 2.0.30 Qualification [1234]' });
...
describe('OpenDeck 2.0.30 editor', () => {

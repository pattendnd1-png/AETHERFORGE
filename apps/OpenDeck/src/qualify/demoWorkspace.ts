...
export function createQualificationWorkspace(): Workspace {
  ...
  page.slots.dials[0].dialStack = {
    ...
    entries: [
      {
        id: 'qualification-dial-stack-volume',
        label: 'Volume',
        bindings: structuredClone(page.slots.dials[0].bindings),
      },
      {
        id: 'qualification-dial-stack-obs',
        label: 'OBS Studio',
        bindings: {
          rotateLeft: createActionInstance('editor.previousPage'),
          rotateRight: createActionInstance('editor.nextPage'),
          pressRotateLeft: createActionInstance('obs.toggleRecord'),
          pressRotateRight: createActionInstance('obs.toggleStream'),
        },
      },
      {
        id: 'qualification-dial-stack-spotify',
        label: 'Spotify',
        bindings: {
          rotateLeft: createActionInstance('editor.previousPage'),
          rotateRight: createActionInstance('editor.nextPage'),

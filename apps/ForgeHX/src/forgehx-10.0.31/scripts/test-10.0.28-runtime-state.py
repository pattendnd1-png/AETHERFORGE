...
if len(sys.argv) != 2:
    raise SystemExit('usage: test-10.0.28-runtime-state.py STATE.json')
doc = json.load(open(sys.argv[1]))
if doc.get('reply') != 'mic_dsp_state':
    raise SystemExit('FORGEHX_10_0_28_RUNTIME_STATE=FAIL:reply_kind')
...
if errors:
    raise SystemExit('FORGEHX_10_0_28_RUNTIME_STATE=FAIL:'+','.join(errors))
print('FORGEHX_10_0_28_RUNTIME_STATE=PASS')

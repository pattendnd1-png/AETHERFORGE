...
checks={
'version':'version = "10.0.22"' in cargo and 'pkgver=10.0.22' in pkg,
...
if failed: raise SystemExit('FORGEHX_10_0_22_SOURCE=FAIL '+','.join(failed))
print('FORGEHX_10_0_22_SOURCE=PASS')

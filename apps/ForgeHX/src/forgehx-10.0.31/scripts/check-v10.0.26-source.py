...
checks={
'version':'version = "10.0.26"' in cargo and 'pkgver=10.0.26' in pkg,
...
'10.0.26 live noise rejection regression':(root/'scripts/test-10.0.26-live-noise-rejection.py').exists(),
}
...
if failed: raise SystemExit('FORGEHX_10_0_26_SOURCE=FAIL '+','.join(failed))
print('FORGEHX_10_0_26_SOURCE=PASS')

...
checks={
'version':'version = "10.0.25"' in cargo and 'pkgver=10.0.25' in pkg,
...
if failed: raise SystemExit('FORGEHX_10_0_25_SOURCE=FAIL '+','.join(failed))
print('FORGEHX_10_0_25_SOURCE=PASS')

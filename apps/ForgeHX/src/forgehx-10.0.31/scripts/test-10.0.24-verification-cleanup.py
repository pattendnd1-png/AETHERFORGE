...
verify = (root/'scripts/verify-10.0.24.sh').read_text() if (root/'scripts/verify-10.0.24.sh').exists() else ''
checks = {
...
print('PASS: ForgeHX 10.0.24 verification/runtime cleanup contract')

...
checks={
 'version':'version = "10.0.28"' in cargo and 'pkgver=10.0.28' in pkg,
 ...
 'single render target':runtime.count('@DEFAULT_AUDIO_SINK@') == 1,
 ...
 'correct verifier parser':'test-10.0.28-runtime-state.py' in read('scripts/verify-10.0.28.sh') if (root/'scripts/verify-10.0.28.sh').exists() else False,
}
...
if failed: raise SystemExit('FORGEHX_10_0_28_SOURCE=FAIL '+','.join(failed))
print('FORGEHX_10_0_28_SOURCE=PASS')

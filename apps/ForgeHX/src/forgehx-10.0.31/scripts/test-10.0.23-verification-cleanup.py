...
verify = (root/'scripts/verify-10.0.23.sh').read_text() if (root/'scripts/verify-10.0.23.sh').exists() else ''
checks = {
...
print('PASS: ForgeHX 10.0.23 verification/runtime cleanup contract')

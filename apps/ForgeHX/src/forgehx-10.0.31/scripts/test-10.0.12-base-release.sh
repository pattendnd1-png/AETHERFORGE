...
grep -q '^version = "10.0.12"$' Cargo.toml || { echo 'workspace version 10.0.12 missing' >&2; exit 1; }
grep -q '^pkgver=10.0.12$' PKGBUILD || { echo 'PKGBUILD pkgver 10.0.12 missing' >&2; exit 1; }
...
echo 'ForgeHX 10.0.12 release identity invariants passed.'

...
verify = (root/'scripts/verify-10.0.25.sh').read_text() if (root/'scripts/verify-10.0.25.sh').exists() else ''
checks = {
...
print('PASS: ForgeHX 10.0.25 verification/runtime cleanup contract')

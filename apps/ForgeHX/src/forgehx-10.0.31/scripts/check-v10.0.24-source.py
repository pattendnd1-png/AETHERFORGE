...
checks={
'version':'version = "10.0.24"' in cargo and 'pkgver=10.0.24' in pkg,
...
if failed: raise SystemExit('FORGEHX_10_0_24_SOURCE=FAIL '+','.join(failed))
print('FORGEHX_10_0_24_SOURCE=PASS')

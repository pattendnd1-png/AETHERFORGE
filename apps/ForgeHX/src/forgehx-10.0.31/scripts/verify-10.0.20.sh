...
printf 'FORGEHX_BASELINE_VERSION=10.0.19\n'
printf 'FORGEHX_UPDATE=PWCLI_REGISTRY_FIXTURE_HOTFIX\n'
...
run SOURCE python3 scripts/check-v10.0.20-source.py
...
run MIC_AETHERSTREAM_BRIDGE python3 scripts/test-10.0.20-aetherstream-bridge.py
...
if (( fail == 0 )); then printf 'FORGEHX_10_0_20_VERIFY=PASS\n'; exit 0; else printf 'FORGEHX_10_0_20_VERIFY=FAIL\n'; exit 1; fi

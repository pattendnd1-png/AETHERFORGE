...
printf 'FORGEHX_BASELINE_VERSION=10.0.18\n'
printf 'FORGEHX_UPDATE=NATIVE_BUILD_REGRESSION_HOTFIX\n'
...
run SOURCE python3 scripts/check-v10.0.19-source.py
...
run MIC_AETHERSTREAM_BRIDGE python3 scripts/test-10.0.19-aetherstream-bridge.py
...
if (( fail == 0 )); then printf 'FORGEHX_10_0_19_VERIFY=PASS\n'; exit 0; else printf 'FORGEHX_10_0_19_VERIFY=FAIL\n'; exit 1; fi

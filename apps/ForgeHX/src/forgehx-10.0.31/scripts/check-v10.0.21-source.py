...
checks={
'version':'version = "10.0.21"' in cargo and 'pkgver=10.0.21' in pkg,
...
if failed: raise SystemExit('FORGEHX_10_0_21_SOURCE=FAIL '+','.join(failed))
print('FORGEHX_10_0_21_SOURCE=PASS')

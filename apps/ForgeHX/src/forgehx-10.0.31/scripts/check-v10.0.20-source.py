...
checks={
'version':'version = "10.0.20"' in cargo and 'pkgver=10.0.20' in pkg,
...
'pw-cli registry fixture regression':(root/'scripts/test-10.0.20-pw-cli-registry-fixture.py').exists(),
}
...
if failed: raise SystemExit('FORGEHX_10_0_20_SOURCE=FAIL '+','.join(failed))
print('FORGEHX_10_0_20_SOURCE=PASS')

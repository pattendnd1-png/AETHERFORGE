...
checks = {
    ...
    'single full-system speaker reference': runtime.count('@DEFAULT_AUDIO_SINK@') == 1,
...
if failed:
    print('FORGEHX_10_0_28_EXTRANEOUS_NOISE_MONITOR=FAIL ' + ','.join(failed))
    raise SystemExit(1)
print('FORGEHX_10_0_28_EXTRANEOUS_NOISE_MONITOR=PASS')

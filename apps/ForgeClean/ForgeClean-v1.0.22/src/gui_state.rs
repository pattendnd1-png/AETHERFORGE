...
use crate::downloads_inventory::{DownloadsInventoryReport, scan_downloads_inventory_summary};
use crate::organizer::ForgeLayout;
use crate::project_storage::{ProjectStorageReport, scan_project_download_storage};
...
pub struct DashboardSnapshot {
    ...
    pub project_storage: ProjectStorageReport,
    pub downloads_inventory: DownloadsInventoryReport,
...
pub fn collect_dashboard_snapshot(downloads: &Path) -> Result<DashboardSnapshot, String> {
    ...
    Ok(DashboardSnapshot {
        ...
        project_storage: scan_project_download_storage(downloads)?,
        downloads_inventory: scan_downloads_inventory_summary(downloads)?,
